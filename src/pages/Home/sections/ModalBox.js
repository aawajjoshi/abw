...
const ModalText = () => {
  return (
    <div>
      ...
      <a href='https://online.skytab.com/e330478ad33cb615b2da04348fee8296' rel='noreferrer' target='_blank'><button className='md-link-icon-clover'>ORDER ONLINE FOR PICKUP OR DELIVERY</button></a>
